...
//4686712/869384/2.50/5/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "OPA656NB_250" (originalName "OPA656NB_250")
	...
	(compDef "OPA656NB_250" (originalName "OPA656NB_250") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "V OUT") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "-V S") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "V IN+") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "V IN–") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "+V S") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "OPA656NB_250"))
		...
		(attr "Mouser Part Number" "595-OPA656NB/250")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/OPA656NB-250?qs=wgAEGBTxy7m%2FGRJS1gt%2FAQ%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "OPA656NB/250")
		(attr "Description" "High Speed Operational Amplifiers Wideband Stable FET-Input")
		(attr "<Hyperlink>" "https://www.ti.com/lit/gpn/OPA656")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "OPA656NB_250.stp")
