...
//852340/869384/2.50/6/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "OPA695IDBVR" (originalName "OPA695IDBVR")
	...
	(compDef "OPA695IDBVR" (originalName "OPA695IDBVR") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "6" (pinName "+V S") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "__DIS") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "INVERTING INPUT") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "OPA695IDBVR"))
		...
		(attr "Mouser Part Number" "595-OPA695IDBVR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/OPA695IDBVR?qs=wgAEGBTxy7kDQsczjqd6Hw%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "OPA695IDBVR")
		(attr "Description" "Ultra-Wideband, Current-Feedback Operational Amplifier with Disable")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/OPA695")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "OPA695IDBVR.stp")
