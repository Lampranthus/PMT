...
figure(6);
subplot(2,8,1:8), plot(X,'r');
subplot(2,8,9), plot(v(2,1:512));
subplot(2,8,10), plot(v(3,1:512));
subplot(2,8,11), plot(v(4,1:512));
subplot(2,8,12), plot(v(5,1:512));
subplot(2,8,13), plot(v(6,1:512));
subplot(2,8,14), plot(v(7,1:512));
subplot(2,8,15), plot(v(8,1:512));
