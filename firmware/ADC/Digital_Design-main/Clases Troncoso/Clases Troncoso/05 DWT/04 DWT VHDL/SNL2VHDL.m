...
% Open VHDL file
fid = fopen('ROM_20LOG10.vhd','wt');
% Description header
fprintf(fid,'library IEEE;\n');
fprintf(fid,'use IEEE.std_logic_1164.all;\n');
fprintf(fid,'use ieee.numeric_std.all;\n');
fprintf(fid,'\n');
fprintf(fid,'entity ROM_20LOG10 is\n');
fprintf(fid,'   port(\n');
...
fprintf(fid,'      );\n');
fprintf(fid,'   end ROM_20LOG10;\n');
fprintf(fid,'\n');
fprintf(fid,'architecture ROM of ROM_20LOG10 is\n');
fprintf(fid,'\n');
