...
% Xn = sin(2.0*pi*(2500/10000.0)*[0:L(1)-1])*0.99;
% Xn = Chirp5_100w;
% Xn = Xn(size(Xn,2):-1:1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Step 3
...
%  subplot(6,1,1), plot(DWTD4*Xn')
%  subplot(6,1,6), plot(Xn)
%  subplot(6,1,2), plot(IWTD1'*(DWTD1*Xn'));
%  subplot(6,1,3), plot(IWTD2'*(DWTD2*Xn'));
%  subplot(6,1,4), plot(IWTD3'*(DWTD3*Xn'));
%  subplot(6,1,5), plot(IWTD4'*(DWTD4*Xn'));
